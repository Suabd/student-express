...
let env = process.env.NODE_ENV || 'development' // a default if no enviromment variable

console.log('using environment' + env)

let configFile = require(__dirname + '/../config.json') // reads all of json from config.json
